      ...
      <div class="hero_area">
         ...
         <section class="slider_section ">
            <div class="slider_bg_box">
               <img src="{{asset('website/images/slider-bg.jpg')}}" alt="">
            </div>
      ...
      <div class="row">
         ...
         <div class="card" style="width: 18rem;">
           ...
           <div class="card-body">
             ...
             <p class="btn-holder"><a href="{{ url('/') }}" class="btn btn-warning btn-block text-center" role="button">Add to cart</a> </p>
           </div>
               ...
               <div class="col-sm-6 col-md-4 col-lg-4">
                  <div class="box">
                     <div class="option_container">
                        <div class="options">
                           <a href="{{route('add.to.cart', $product->id) }}" class="option1">
                           Add To Cart
                           </a>
                           <a href="{{route('buy.now', $product->id)}}" class="option2">
                           Buy Now
                           </a>
                        </div>
                     </div>
                     <div class="img-box">
                        <img src="{{asset('/storage/product/'.$product->file_path) }}" alt="">
                     </div>
                     <div class="detail-box">
                        <h5>
                           {{$product->pname}}
