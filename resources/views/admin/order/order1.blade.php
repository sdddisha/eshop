        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{url('student/logout')}}" data-toggle="modal" data-target="#logoutModal">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Placed Orders</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <td>Order Created at</td>
                            ...
                            <td>{{$crud->total}}</td>
                            <td>{{$crud->status}}</td>
                            <td>{{$crud->payment_status}}</td>
                            <td>{{$crud->payment_method}}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="{{url('teacher/logout')}}">Logout</a>
                </div>
            </div>
        </div>
    </div>
