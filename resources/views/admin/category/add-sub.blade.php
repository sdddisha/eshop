...
<form method="POST" action="{{url('insert-sub_category')}}" >
 @csrf
<div class="row">
<div class="col-md-6">
    <label for="validationDefault04" class="form-label">Select Category</label>
    <select class="form-select"  name="parent_id" id="validationDefault04">
 ...
 <div class="row">
  <div class="col-md-6">
    ...
    <label for="validationDefault01" class="form-label">Sub-Category name</label>
    <input type="text" name ="name" class="form-control" id="validationDefault01" required>
  </div>

  <div class="col-md-6">
    <label for="validationDefault02" class="form-label">Slug</label>
    <input type="text" name ="slug" class="form-control" id="validationDefault02"  required>
  </div>
