...
#customers th {
  ...
  color: white;
    ...
    <title>Show Categories and sub categories</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">All Categories and Subcategories</h1>
                    <table id="customers" >
                        <tr>
                        ...
                        @foreach($category as $crud)
                            ...
                            <td>    
                            <a href="delete-cat/{{$crud->id}}" class="button delete-confirm">Delete</a>
                            </td></tr>
                            @endforeach
          </table>
