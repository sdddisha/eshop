        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Added Pages</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <td>Action</td>
                            ...
                            <td>
                                <a href="add-details/{{$crud->id}}" >Add details</a>
                                <a href="delete-page/{{$crud->id}}" class="button delete-confirm">Delete</a>
                            </td>
                                                </tr>
                                                @endforeach
                                                </tbody>
